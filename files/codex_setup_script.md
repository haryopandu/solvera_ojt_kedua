Di bawah ini adalah setup script idempotent yang disarankan oleh ChatGPT untuk variabel lingkungan (environment variables) Codex OpenAI setelah mempertimbangkan saran dari Codex:
